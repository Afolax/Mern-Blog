...
export default function PostUpdate() {
    ...
    const handleUploadImage = async() => {
        try{
            ...
            setImageUploadError('Image upload faled!!!')
            setImageUploadProgress(null)
            console.log(error)
        }
    }
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <Textarea type='text' placeholder='write somethng' className='h-72 mb-10' required onChange={(e) => setFormData({...formData, content: e.target.value})} value={formData.content}/> 
