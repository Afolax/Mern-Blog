...
export default function DashProfile() {
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <div className='relative w-32 h-33 self-center cursor-pointer shadow-md overflow-hidden rounded-full' onClick={() => filePickerRef.current.click()}>
      ...
      <div className="text-red-500 flex justify-between">
        <span onClick={() => setShowModel(true)} className='cursor-pointer'>Delete</span>
